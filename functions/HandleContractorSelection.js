...
async function handleContractorSelection(interaction) {
    const channel = interaction.channel;
    await channel.send("Hello! I'm here to assist you to apply for the Helper Position 😊");
    await sleep(1000);
    await channel.send("First let me tell you some ROLE SPECIFIC requirements and rules that apply to just helper! Just give me one moment...")
    await sleep(4000);
    const embed = new EmbedBuilder()
    .setColor('#FF0000')
    .setTitle(`Helper Requirements And Rules`)
  ...
  module.exports = { handleContractorSelection };